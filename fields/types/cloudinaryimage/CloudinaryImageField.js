...
const SUPPORTED_TYPES = ['video/*', 'audio/*', 'image/*', 'application/pdf', 'application/postscript'];
const SUPPORTED_REGEX = new RegExp(/^video\/|audio\/|image\/|application\/pdf|application\/postscript/g);
...
module.exports = Field.create({
	...
	handleImageChange (e) {
		...
		if (!file.type.match(SUPPORTED_REGEX)) {
			return alert('Unsupported file type. Supported formats are: GIF, PNG, JPG, BMP, ICO, PDF, TIFF, EPS, PSD, SVG, MP4, WEBM, FLV, MOV, OGV, 3GP, 3G2, WMV, MPEG, FLV, MKV, AVI OR MP3.');
		}
